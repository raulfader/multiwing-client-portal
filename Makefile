build-DuplicateApiFunction:
	...
	./node_modules/.bin/esbuild server/aws/thumbnailCopier.ts --bundle --platform=node --format=cjs --target=node22 --main-fields=module,main --outfile="$(ARTIFACTS_DIR)/thumbnailCopier.js"
